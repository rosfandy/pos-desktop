...
const Input = React.forwardRef<HTMLInputElement, React.ComponentPropsWithoutRef<"input">>(
  ...
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        `text-[12px]! h-8 w-full min-w-0 rounded-lg border border-input
         bg-gray-100 dark:bg-[#0f0f0f] text-foreground px-2.5 py-1 text-base transition-colors outline-none 
